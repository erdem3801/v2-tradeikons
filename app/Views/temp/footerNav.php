<div class="ec-nav-toolbar">
    <div class="container">
        <div class="ec-nav-panel">
            ...
            <div class="ec-nav-panel-icons">
                <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><img src="<?= base_url('public')  ?>/assets/images/icons/cart.svg" class="svg_img header_svg" alt="icon" /><span class="ec-cart-noti ec-header-count cart-count-lable"><?= $basketCount ?? 0  ?></span></a>
            </div>
            <div class="ec-nav-panel-icons">
